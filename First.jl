# Convert the MATLAB Jaya algorithm code to equivalent Julia code and write to file
...
# Plot convergence
plot(best_history, lw=2, xlabel="Iteration", ylabel="Minimum Objective Function (Deflection Proxy)",
